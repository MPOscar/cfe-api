package rondanet.cfe.core.utils;

import rondanet.cfe.CfeConfiguration;
...
public class MandrillEmailHelper implements IEmailHelper {
    ...
    @Autowired
    private CfeConfiguration configuration;
    @SuppressWarnings("unused")
    private MandrillConfiguration mandrillConfig;
    public MandrillEmailHelper(CfeConfiguration configuration) {
